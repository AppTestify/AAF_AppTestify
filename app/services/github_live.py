...
def fetch_github_signal(repo: str, token: Optional[str] = None, timeout_seconds: int = 5) -> dict[str, Any]:
    ...
    with httpx.Client(timeout=timeout_seconds, headers=headers) as client:
        repo_data = get_json_with_retry(client, f"https://api.github.com/repos/{repo}")
        runs_data = get_json_with_retry(client, f"https://api.github.com/repos/{repo}/actions/runs?per_page=20")
