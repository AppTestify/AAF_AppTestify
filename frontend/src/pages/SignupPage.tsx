      ...
      <div className="auth-panel">
        <div className="auth-surface">
          <div className="card auth-card-main">
            <div className="auth-badge">Governed Tenant Provisioning</div>
            <h1 className="auth-heading">Create your organization</h1>
            <p className="auth-sub">Set up your tenant and become the governance administrator for your workspace.</p>

            {enabled === false ? (
              <div className="alert alert-error" role="alert">
                Self-service signup is disabled on this server. Ask your platform owner for an account, or sign in if you already have one.
              </div>
            ) : null}
          ...
          <div className="card auth-card-side">
            <h2>What you get after provisioning</h2>
            <p>Your tenant is created with governance-ready boundaries and administrator control by default.</p>
            <div className="auth-kpis">
              <div className="auth-kpi">
                <span className="label">Tenant mode</span>
                <strong>Isolated workspace</strong>
              </div>
              <div className="auth-kpi">
                <span className="label">Control model</span>
                <strong>Role-based governance</strong>
              </div>
            </div>
            <ul className="auth-points">
              <li>Connector and AI provider controls per tenant</li>
              <li>Auditable runs, cases, decisions, and alerts</li>
              <li>Export-ready evidence and reporting workflows</li>
            </ul>
          </div>
        </div>
